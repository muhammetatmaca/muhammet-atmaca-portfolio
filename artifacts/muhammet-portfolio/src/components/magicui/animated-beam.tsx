...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  useEffect(() => {
    ...
    // Recalculate across multiple frames to account for layout shifts / accordion expansion
    const timer1 = setTimeout(updatePath, 50);
    const timer2 = setTimeout(updatePath, 200);
    const timer3 = setTimeout(updatePath, 400);
  ...
  if (!svgDimensions.width || !svgDimensions.height || !pathD) {
    return null;
  }
